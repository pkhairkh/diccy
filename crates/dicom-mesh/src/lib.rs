...
pub fn encode_3d_model_iod(
    ...
    ds.insert(Element {
        ...
        vr: Vr::Ui,
        value: Value::Uid("1.2.840.10008.5.1.4.1.1.104.1".to_string()),
    });
    ...
    ds.insert(Element {
        ...
        vr: Vr::Ui,
        value: Value::Uid(frame_of_ref_uid.to_string()),
    });
    ...
    ds.insert(Element {
        ...
        vr: Vr::Is,
        value: Value::Str("9000".to_string()),
    });
    ...
    ds.insert(Element {
        ...
        vr: Vr::Lo,
        value: Value::Str("3D MODEL".to_string()),
    });
    ...
    ds.insert(Element {
        ...
        vr: Vr::Lo,
        value: Value::Str(format!("3D model: {}", mesh.label)),
    });
    ...
    ds.insert(Element {
        ...
        vr: Vr::Cs,
        value: Value::Str("IDENTITY".to_string()),
    });
    ...
    ds.insert(Element {
        ...
        vr: Vr::Ul,
        value: Value::I32(mesh.vertex_count() as i32),
    });
    ...
    ds.insert(Element {
        ...
        vr: Vr::Ul,
        value: Value::I32(mesh.triangle_count() as i32),
    });
    ...
    ds.insert(Element {
        ...
        vr: Vr::St,
        value: Value::Str("Generated by dicom-mesh marching cubes".to_string()),
    });
