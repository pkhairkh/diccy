...
use pack_enhanced::{select_frame_groups, EnhancedPack, SOP_CLASS_ENHANCED_MR};
#[cfg(feature = "pack-enhanced")]
...
/// Check whether the dataset references an enhanced (multi-frame) SOP class.
#[cfg(feature = "pack-enhanced")]
pub fn is_enhanced_sop_class(dataset: &Dataset, limits: &Limits) -> Result<bool> {
