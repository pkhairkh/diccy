...
pub use gsdf::{
    ...
    GSDF_L_MAX, GSDF_L_MIN, GSDF_P_VALUE_COUNT,
};
...
/// Compute the angle in degrees at `vertex` formed by rays to `b` and `c`.
pub fn angle_degrees(vertex: ImagePoint, b: ImagePoint, c: ImagePoint) -> Option<f64> {
