...
use dicom_core::{
    parse_f64_strict, parse_i32_strict, Dataset, Element, Error, ErrorKind, Result, Tag, Value, Vr,
};
...
/// DICOM Tag (0x0018,0x1600) TAG_SHUTTER_SHAPE
pub const TAG_SHUTTER_SHAPE: Tag = Tag(0x0018, 0x1600);
/// DICOM Tag (0x0018,0x1602) TAG_SHUTTER_LEFT_VERT_EDGE
pub const TAG_SHUTTER_LEFT_VERT_EDGE: Tag = Tag(0x0018, 0x1602);
/// DICOM Tag (0x0018,0x1604) TAG_SHUTTER_RIGHT_VERT_EDGE
pub const TAG_SHUTTER_RIGHT_VERT_EDGE: Tag = Tag(0x0018, 0x1604);
/// DICOM Tag (0x0018,0x1606) TAG_SHUTTER_UPPER_HORIZ_EDGE
pub const TAG_SHUTTER_UPPER_HORIZ_EDGE: Tag = Tag(0x0018, 0x1606);
/// DICOM Tag (0x0018,0x1608) TAG_SHUTTER_LOWER_HORIZ_EDGE
pub const TAG_SHUTTER_LOWER_HORIZ_EDGE: Tag = Tag(0x0018, 0x1608);
/// DICOM Tag (0x0018,0x160A) TAG_SHUTTER_CENTER
pub const TAG_SHUTTER_CENTER: Tag = Tag(0x0018, 0x160A);
/// DICOM Tag (0x0018,0x160C) TAG_SHUTTER_RADIUS
pub const TAG_SHUTTER_RADIUS: Tag = Tag(0x0018, 0x160C);
/// DICOM Tag (0x0018,0x1620) TAG_SHUTTER_VERTICES
pub const TAG_SHUTTER_VERTICES: Tag = Tag(0x0018, 0x1620);
/// DICOM Tag (0x0018,0x1622) TAG_SHUTTER_PRESENTATION_VALUE
pub const TAG_SHUTTER_PRESENTATION_VALUE: Tag = Tag(0x0018, 0x1622);
/// DICOM Tag (0x0070,0x0001) TAG_GRAPHIC_ANNOTATION_SEQUENCE
pub const TAG_GRAPHIC_ANNOTATION_SEQUENCE: Tag = Tag(0x0070, 0x0001);
/// DICOM Tag (0x0070,0x0009) TAG_GRAPHIC_OBJECT_SEQUENCE
pub const TAG_GRAPHIC_OBJECT_SEQUENCE: Tag = Tag(0x0070, 0x0009);
/// DICOM Tag (0x0070,0x0022) TAG_GRAPHIC_DATA
pub const TAG_GRAPHIC_DATA: Tag = Tag(0x0070, 0x0022);
/// DICOM Tag (0x0070,0x0023) TAG_GRAPHIC_TYPE
pub const TAG_GRAPHIC_TYPE: Tag = Tag(0x0070, 0x0023);

// Tags for GSPS writeback
/// DICOM Tag (0x0008,0x0016) TAG_SOP_CLASS_UID
pub const TAG_SOP_CLASS_UID: Tag = Tag(0x0008, 0x0016);
/// DICOM Tag (0x0008,0x1115) TAG_REFERENCED_SERIES_SEQUENCE
pub const TAG_REFERENCED_SERIES_SEQUENCE: Tag = Tag(0x0008, 0x1115);
/// DICOM Tag (0x0008,0x1140) TAG_REFERENCED_IMAGE_SEQUENCE
pub const TAG_REFERENCED_IMAGE_SEQUENCE: Tag = Tag(0x0008, 0x1140);
/// DICOM Tag (0x0008,0x1150) TAG_REFERENCED_SOP_CLASS_UID
pub const TAG_REFERENCED_SOP_CLASS_UID: Tag = Tag(0x0008, 0x1150);
/// DICOM Tag (0x0008,0x1155) TAG_REFERENCED_SOP_INSTANCE_UID
pub const TAG_REFERENCED_SOP_INSTANCE_UID: Tag = Tag(0x0008, 0x1155);
/// DICOM Tag (0x0028,0x1050) TAG_WINDOW_CENTER
pub const TAG_WINDOW_CENTER: Tag = Tag(0x0028, 0x1050);
/// DICOM Tag (0x0028,0x1051) TAG_WINDOW_WIDTH
pub const TAG_WINDOW_WIDTH: Tag = Tag(0x0028, 0x1051);
/// DICOM Tag (0x0070,0x0202) TAG_IMAGE_HORIZONTAL_FLIP
pub const TAG_IMAGE_HORIZONTAL_FLIP: Tag = Tag(0x0070, 0x0202);
/// DICOM Tag (0x0070,0x0204) TAG_IMAGE_ROTATION
pub const TAG_IMAGE_ROTATION: Tag = Tag(0x0070, 0x0204);
/// DICOM Tag (0x0070,0x0050) TAG_DISPLAYED_AREA_SELECTION_SEQUENCE
pub const TAG_DISPLAYED_AREA_SELECTION_SEQUENCE: Tag = Tag(0x0070, 0x0050);
/// DICOM Tag (0x0070,0x0052) TAG_DISPLAYED_AREA_TOP_LEFT
pub const TAG_DISPLAYED_AREA_TOP_LEFT: Tag = Tag(0x0070, 0x0052);
/// DICOM Tag (0x0070,0x0100) TAG_PRESENTATION_PIXEL_MAGNIFICATION_RATIO
pub const TAG_PRESENTATION_PIXEL_MAGNIFICATION_RATIO: Tag = Tag(0x0070, 0x0100);

// ---------------------------------------------------------------------------
// Rendering helpers (feature-gated behind "rendering")
// ---------------------------------------------------------------------------

/// Graphic luma value for rendering
#[cfg(feature = "rendering")]
pub const GRAPHIC_LUMA: u8 = 0xFF;
#[cfg(feature = "rendering")]
const GRAPHIC_COLOR: [u8; 3] = [0xFF, 0x00, 0x00];
/// Epsilon value for GRAPHIC_EPS
pub const GRAPHIC_EPS: f64 = 1e-6;
/// Epsilon value for GRAPHIC_POINT_EPS
pub const GRAPHIC_POINT_EPS: f64 = 1e-3;
/// Epsilon value for GRAPHIC_ORTHO_EPS
pub const GRAPHIC_ORTHO_EPS: f64 = 1e-3;
#[cfg(feature = "rendering")]
...
/// Helper function for read_graphic_points
pub fn read_graphic_points(dataset: &Dataset) -> Result<Vec<(f64, f64)>> {
...
/// Helper function for read_f64_list
pub fn read_f64_list(dataset: &Dataset, tag: Tag) -> Result<Vec<f64>> {
...
/// Helper function for read_sequence
pub fn read_sequence(dataset: &Dataset, tag: Tag) -> Result<Option<&[Dataset]>> {
    match dataset.get(tag) {
        Some(element) => match element.value() {
...
/// Helper function for read_i32_list
pub fn read_i32_list(dataset: &Dataset, tag: Tag, expected: usize) -> Result<[i32; 2]> {
    let Some(raw) = read_str(dataset, tag)? else {
        return Err(missing_required_tag(tag));
    };
...
/// Helper function for read_i32_vec
pub fn read_i32_vec(dataset: &Dataset, tag: Tag) -> Result<Vec<i32>> {
    let Some(raw) = read_str(dataset, tag)? else {
        return Err(missing_required_tag(tag));
    };
    let parts: Vec<&str> = raw.split('\\').collect();
...
/// Helper function for read_shutter_value
pub fn read_shutter_value(dataset: &Dataset) -> Result<u8> {
...
pub fn encode_presentation_state(state: &PresentationState) -> Dataset {
    ...
    dataset.insert(
        Element::new(
            TAG_SOP_CLASS_UID,
            Vr::Ui,
            Value::Uid(SOP_CLASS_GSPS.to_string()),
        )
        .unwrap(),
    );
    ...
    if let (Some(center), Some(width)) = (state.window_center, state.window_width) {
        if center.is_finite() && width.is_finite() && width > 0.0 {
            dataset.insert(
                Element::new(TAG_WINDOW_CENTER, Vr::Ds, Value::Str(format_ds(center))).unwrap(),
            );
            dataset.insert(
                Element::new(TAG_WINDOW_WIDTH, Vr::Ds, Value::Str(format_ds(width))).unwrap(),
            );
        }
    }
...
pub fn encode_viewport_as_gsps(viewport: &ViewportState) -> Dataset {
    ...
    referenced_image.insert(
        Element::new(
            TAG_REFERENCED_SOP_INSTANCE_UID,
            Vr::Ui,
            Value::Uid(viewport.referenced_sop_instance_uid.clone()),
        )
        .unwrap(),
    );

    let mut referenced_series = Dataset::new();
    referenced_series.insert(
        Element::new(
            TAG_REFERENCED_IMAGE_SEQUENCE,
            Vr::Sq,
            Value::Sequence(vec![referenced_image]),
        )
        .unwrap(),
    );
    ...
    dataset.insert(
        Element::new(
            ...
            Vr::Sq,
            Value::Sequence(vec![referenced_series]),
        )
        .unwrap(),
    );
        ...
        Shutter::Circular {
            ...
            dataset.insert(
                Element::new(
                    TAG_SHUTTER_CENTER,
                    Vr::Is,
                    Value::Str(format!("{}\\{}", center_x, center_y)),
                )
                .unwrap(),
            );
            dataset.insert(
                Element::new(TAG_SHUTTER_RADIUS, Vr::Is, Value::Str(radius.to_string())).unwrap(),
            );
            dataset.insert(
                Element::new(
                    TAG_SHUTTER_PRESENTATION_VALUE,
    ...
    let graphic_items: Vec<Dataset> = graphics
        ...
        .map(|g| {
            ...
            let (graphic_type, graphic_data) = match g {
                GraphicObject::Point { point } => {
                    ("POINT", format_ds(point.0) + "\\" + &format_ds(point.1))
                }
                GraphicObject::Polyline { points } => {
            ...
            item.insert(Element::new(TAG_GRAPHIC_DATA, Vr::Ds, Value::Str(graphic_data)).unwrap());
            item
        })
        .collect();
...
fn encode_spatial_transform(dataset: &mut Dataset, state: &PresentationState) {
    ...
    dataset.insert(
        Element::new(
            TAG_IMAGE_HORIZONTAL_FLIP,
            Vr::Cs,
            Value::Str(if effective_flip_x {
                "Y".to_string()
            } else {
                "N".to_string()
            }),
    ...
    dataset.insert(
        Element::new(
            TAG_IMAGE_ROTATION,
            Vr::Is,
            Value::Str((effective_rotation * 90).to_string()),
        )
        .unwrap(),
    );
    ...
    if has_zoom || has_pan {
        ...
        if let Some(zoom) = state.zoom {
            if zoom.is_finite() && zoom > 0.0 {
                area_item.insert(
                    Element::new(
                        TAG_PRESENTATION_PIXEL_MAGNIFICATION_RATIO,
                        Vr::Ds,
                        Value::Str(format_ds(zoom)),
                    )
                    .unwrap(),
                );
            }
        ...
        if has_pan {
            ...
            if pan_x.is_finite() && pan_y.is_finite() {
                area_item.insert(
                    Element::new(
                        TAG_DISPLAYED_AREA_TOP_LEFT,
                        Vr::Ds,
                        Value::Str(format!("{}\\{}", format_ds(pan_y), format_ds(pan_x))),
                    )
                    .unwrap(),
                );
            }
